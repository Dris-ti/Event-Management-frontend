    ...
    <div className='w-full h-screen bg-[#ECEEFF]'>
      ...
      <div className='flex items-center justify-center min-h-screen'>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-96 relative">
          {/* Text heading */}
          <h2 className="text-2xl font-semibold text-[#242565] mb-2">Sign in</h2>
          <p className="mb-6 text-sm text-[#8570AD]">
            New User?{" "}
            <a href="/SignUp" className="text-[#8570AD] underline hover:brightness-75 transition">
              Create an account
            </a>
          </p>
          ...
          <form className="space-y-4"
            ...
            <div>
              ...
              <input
                ...
                className="placeholder-[#B3B3B3] w-full px-4 py-2 border-1 border-[#D9D9D9] rounded-md outline-none focus:ring-2 focus:ring-[#8470AD]"
              />
            </div>
